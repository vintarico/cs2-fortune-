      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        <div className="flex items-center space-x-8">
          ...
          <div className="hidden md:flex space-x-6">
            <Link href="/cases">
              <span className="text-gray-300 hover:text-white cursor-pointer">Cases</span>
            </Link>
            <Link href="/deposit">
              <span className="text-gray-300 hover:text-white cursor-pointer">Deposit</span>
            </Link>
            <Link href="/withdraw">
              <span className="text-gray-300 hover:text-white cursor-pointer">Withdraw</span>
            </Link>
          </div>
        </div>
